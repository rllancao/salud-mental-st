...
def crear_interfaz_wonderlic(supabase: Client):
    ...
    # --- Estado 2: El Test (Con Temporizador) ---
        ...
        # Cálculo del tiempo (12 minutos = 720 segundos)
        ...
        # --- PREGUNTAS DEL TEST (SIN st.form para permitir autoguardado real) ---
        # Al quitar st.form, las respuestas se guardan en session_state inmediatamente al hacer click.
        ...
        st.markdown("---")
        siguiente_button = st.button("Finalizar y Guardar", type="primary")
        ...
        if siguiente_button or is_time_up:
            if not st.session_state.wonderlic_submitted:
                ...
                with st.spinner("Procesando y guardando respuestas..."):
                    ...
                    # --- Lógica de Corrección (Puntaje) ---
                    # Claves corregidas a 'pregunta_X' para coincidir con la base de datos
                    ...
                    wonderlic_data_to_save = {
                        ...
                        **resultados_correctas, # Se guardan pregunta_1..pregunta_50
                    ...
                    try:
                        ...
                        if response.data:
                            # Limpiar variables
                            keys_to_delete = ['wonderlic_start_time', 'wonderlic_submitted', 'wonderlic_started', 'wonderlic_comprende']
                            # Limpiar también las keys del form para que no queden en memoria
                            for i in range(1, 51):
                                keys_to_delete.append(f"q{i}")
        ...
        # Actualizar el reloj (autoguardado por tiempo)
        elif not st.session_state.wonderlic_submitted:
            time.sleep(719) # Intervalo breve para actualizar el contador
            st.rerun()