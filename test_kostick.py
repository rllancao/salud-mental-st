...
KOSTICK_QUESTIONS = {
    ...
    12: {"opcion_1": {"texto": "No me altero fácilmente.", "factor": "Z"},
         "opcion_0": {"texto": "Consigo que la gente haga lo que yo quiero.", "factor": "L"}}, 
    ...
    43: {"opcion_1": {"texto": "A menudo me arriesgo”.", "factor": "I"},
         "opcion_0": {"texto": "Me gusta darle importancia a las cosas comunes.", "factor": "D"}},
    ...
    72: {"opcion_1": {"texto": "Normalmente tengo prisa.", "factor": "T"},
         "opcion_0": {"texto": "El grupo hace normalmente lo que yo quiero.", "factor": "L"}},
